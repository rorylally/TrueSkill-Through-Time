#[All_2024_R1] Accuracy — TTT (from CSV skills): 62.46% | Bookmakers: 68.37% (same 1132 matches)
#[ATP250] Accuracy — TTT (from CSV skills): 58.72% | Bookmakers: 66.23% (same 453 matches)                    
#[ATP500] Accuracy — TTT (from CSV skills): 63.74% | Bookmakers: 68.13% (same 182 matches)                    
#[Masters1000] Accuracy — TTT (from CSV skills): 58.82% | Bookmakers: 65.61% (same 221 matches)               
#[Grandslams] Accuracy — TTT (from CSV skills): 71.94% | Bookmakers: 75.89% (same 253 matches)  
...
write_csv(results_df, "accuracy_summary_BASELINEv6.csv")
