...
# Save outputs
write_csv(disagree_df, "bet365_right_ttt_wrong_test.csv")
write.csv(all_df_export, "Global_TTT_rolling_result_test.csv", row.names = FALSE)
write_xlsx(all_df_export, "Global_TTT_rolling_result_test.xlsx")
cat("Files written: Global_TTT_rolling_result_test.[csv/xlsx] and bet365_right_ttt_wrong_test.csv\n")
...
cat(sprintf("Accuracy — TTT: %.2f%% | Bet365: %.2f%% (same %d matches)\n",
            ttt_acc, book_acc, n_comp))
write_csv(acc_table, "bet365_directional_accuracy_test.csv")