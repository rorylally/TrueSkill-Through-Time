...
print(ttt_table)
readr::write_csv(ttt_table, "ttt_accuracy_by_year_grandslam.csv")
...
# Save outputs
write_csv(disagree_df, "bet365_right_ttt_wrong_grandslam.csv")
write.csv(all_df_export, "Global_TTT_rolling_result_grandslam.csv", row.names = FALSE)
write_xlsx(all_df_export, "Global_TTT_rolling_result_grandslam.xlsx")
cat("Files written: Global_TTT_rolling_result_grandslam.[csv/xlsx] and bet365_right_ttt_wrong_grandslam.csv\n")
...
cat(sprintf("Accuracy — TTT: %.2f%% | Bet365: %.2f%% (same %d matches)\n",
            ttt_acc, book_acc, n_comp))
write_csv(acc_table, "bet365_directional_accuracy_grandslam.csv")