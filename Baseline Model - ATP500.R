...
TARGET_ATP <- c(12, 15, 16, 17, 25, 35, 36, 47, 54, 55, 60 ,61)
...
print(ttt_table)
readr::write_csv(ttt_table, "ttt_accuracy_by_year_ATP500.csv")
...
# Save outputs
write_csv(disagree_df, "bet365_right_ttt_wrong_ATP500.csv")
write.csv(all_df_export, "Global_TTT_rolling_result_ATP500.csv", row.names = FALSE)
write_xlsx(all_df_export, "Global_TTT_rolling_result_ATP500.xlsx")
cat("Files written: Global_TTT_rolling_result_ATP500.[csv/xlsx] and bet365_right_ttt_wrong_ATP500.csv\n")
...
cat(sprintf("Accuracy — TTT: %.2f%% | Bet365: %.2f%% (same %d matches)\n",
            ttt_acc, book_acc, n_comp))
write_csv(acc_table, "bet365_directional_accuracy_ATP500.csv")