...
# Save outputs
write_csv(disagree_df, "bet365_right_ttt_wrong_base_v3.csv")
write.csv(all_df_export, "Global_TTT_rolling_result_base_v3.csv", row.names = FALSE)
write_xlsx(all_df_export, "Global_TTT_rolling_result_base_v3.xlsx")
cat("Files written: Global_TTT_rolling_result_base_v3.[csv/xlsx] and bet365_right_ttt_wrong_base_v3.csv\n")
...
cat(sprintf("Accuracy — TTT: %.2f%% | Bet365: %.2f%% (same %d matches)\n",
            ttt_acc, book_acc, n_comp))
write_csv(acc_table, "bet365_directional_accuracy_base_v3.csv")
